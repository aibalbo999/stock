...
- 前端介面：Streamlit 提供分析、報告、資料、設定頁；各 page 使用明確 import，API client、背景任務狀態面板、報告狀態 hydration、報告 markdown parsing、候選審計 renderer、報告 HTML renderer、報告查核 panels、補強狀態與維護稽核摘要都拆成獨立 UI helper。
