...
- 系統狀態檢查：`service_status` 負責彙整整體狀態，前端 MPA/背景任務 ready 條件、LLM 額度/降級路由、市場資料快取/來源後援、GraphRAG/Neo4j runtime 與公司文件爬蟲/PDF runtime 由獨立 status collector 掃描，避免單一 audit 檔案持續膨脹。
