...
class LegacyApiFacade:
    """Compatibility boundary for legacy tests and script imports.

    The public FastAPI routes now call router-specific services, but older tests and
    internal scripts still import helper functions from app.api.main. Keeping the
    delegation here prevents main.py from growing back into a business-logic module.
    """
    ...
    async def run_report_follow_up(
        self,
        report_id: int,
        payload: FollowUpRunRequest | None = None,
    ) -> dict:
