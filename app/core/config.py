...
class Settings(BaseSettings):
    ...
    company_filing_browser_render_provider: str = "browserless"
    ...
    company_filing_structured_api_provider: str = ""
    company_filing_structured_api_url: str = ""
    company_filing_structured_api_token: str = ""
    ...
    company_filing_visual_rag_timeout_seconds: float = 60.0
    vector_db_path: Path = Path(".chroma")
    use_chroma: bool = False
    chroma_api_url: str = ""
    chroma_tenant: str = "default_tenant"
    chroma_database: str = "default_database"
    rag_embedding_provider: str = "google_genai"
    ...
    rag_llm_reranker_max_documents: int = 8
    neo4j_uri: str = ""
    neo4j_user: str = ""
    ...
    llm_observability_external_dispatch_enabled: bool = True
    llm_observability_project_name: str = "stock-analysis"
    llm_observability_export_timeout_seconds: float = 2.0
