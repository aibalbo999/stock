...
from app.services.followup_evidence_cache import (
    cached_follow_up_news_items as cached_follow_up_news_items,
    dedupe_follow_up_items as dedupe_follow_up_items,
    filter_follow_up_target_items as filter_follow_up_target_items,
    has_follow_up_target_match as _has_follow_up_target_match,
)
