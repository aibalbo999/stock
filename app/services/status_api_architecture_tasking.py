...
def api_tasking_architecture_status(source_context: ApiArchitectureSourceContext) -> dict:
    ...
    sync_report_async_refresh_gates_present = (
        "sync_pre_refresh_requested=sync_pre_refresh_enabled" in report_service_factory_source
    ...
    sync_report_background_hint_present = (
        '"background_task_endpoint": "POST /reports/generate_async"' in report_generation_api_source
    ...
    return {
        ...
        "api_tasking_architecture_status_path": ("app/services/status_api_architecture_tasking.py"),
        ...
        "compatibility_exports_imports_tasks": "from app.tasks."
        in (sources["compatibility_exports"]),
...
def _task_submission_error_status(source_context: ApiArchitectureSourceContext) -> dict:
    ...
    analysis_run_repository_source = sources["analysis_run_repository"]
    ...
    return {
        ...
        "background_task_control_handlers_extracted": (background_task_control_handlers_extracted),
        ...
        "task_failure_diagnostics_shared_service": paths["task_failure_diagnostics"].exists()
        ...
        "task_failure_diagnostics_persisted_to_run_payload": (
            "task_failure_diagnostic_payload" in analysis_run_repository_source
            and '"task_failure_diagnostic"' in analysis_run_repository_source
            and "def _clear_task_failure_diagnostic(" in analysis_run_repository_source
        ),
        "task_submission_error_endpoint_coverage": {
            ...
            and "submit_data_operation_task(" in operations_routes_source,
            "report_follow_up": 'operation="report_follow_up"' in background_task_submission_source
            and "submit_report_follow_up_task(" in report_routes_source,
        },
