    ...
    *,
    ...
    return {
        ...
        "streamlit_mpa_background_tasks": _capability(
            ...
            and frontend_status.get("ui_operator_secondary_decisions_extracted")
            ...
            and frontend_status.get("ui_operator_optimization_actions_extracted")
            ...
            and frontend_status.get("ui_report_center_document_panel_extracted")
            ...
            and frontend_status.get("ui_data_enrichment_common_view_extracted")
            and frontend_status.get("ui_data_enrichment_market_presenter_extracted")
            and frontend_status.get("ui_data_enrichment_market_operations_extracted")
            and frontend_status.get("ui_data_enrichment_market_view_extracted")
            ...
            and frontend_status.get("ui_maintenance_incident_presenter_extracted")
            and frontend_status.get("ui_maintenance_incident_view_extracted")
            and frontend_status.get("ui_optimization_progress_view_extracted")
            ...
            and frontend_status.get("ui_optimization_progress_presenter_extracted")
            ...
            and frontend_status.get("ui_maintenance_operation_controls_extracted")
            and frontend_status.get(
            ...
            and frontend_status.get("ui_task_failure_catalog_extracted")
            ...
            and frontend_status.get("ui_task_status_view_extracted")
