...
TASK_FAILURE_CATEGORIES = {
    ...
    "external_config": {
        ...
        "keywords": (
            ...
            "structured api not configured",
            "structured_api_configuration",
            "missing_structured_api_provider_or_url",
            "missing_structured_api_token",
            "invalid_structured_api_url",
            "browser_render_not_configured",
            "missing_browser_render_url",
            "missing_browser_render_token",
            "invalid_browser_render_url",
            "unsupported_browser_render_provider",
            "missing_vision_llm_key_or_gateway",
            "missing_settings:neo4j",
