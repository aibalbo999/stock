...
def audit_upgrade_capabilities(
    ...
    *,
    ...
    audit["external_deployment_local_projection"] = _external_deployment_local_projection(
...
def _external_deployment_local_projection(
    *,
    pending_gaps: list[dict],
    local_dependency_auto_defaults: dict,
) -> dict:
    local_matches = _local_default_capability_matches(local_dependency_auto_defaults)
    local_default_rows = [
        row
