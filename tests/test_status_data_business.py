...
def test_data_business_capability_matrix_shape_and_evidence(service_status_snapshot) -> None:
    ...
    assert report_retention["evidence"]["report_file_write_retains_latest_version"] is True
    assert report_retention["evidence"]["repository_create_retains_latest_version"] is True
