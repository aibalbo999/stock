...
def test_streamlit_shell_uses_operational_workspace_header() -> None:
    ...
    assert "disabled=not cancel_confirmed" in ui.TASK_STATUS_PANEL_SOURCE.read_text()
    assert "disabled=not retry_confirmed" in ui.TASK_STATUS_PANEL_SOURCE.read_text()
